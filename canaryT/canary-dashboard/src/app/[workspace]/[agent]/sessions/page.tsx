...
export default function SessionsPage() {
  ...
  const processedData = useMemo(() => {
    let data = MOCK_SESSIONS.filter((r) => r.agentId === agentId);
    // Apply filters
    ...
    return data;
  }, [search, colSortKey, colSortDir, filters, agentId]);
  ...
  return (
    <div className="flex" style={{ minHeight: '100vh' }}>
      <CollapsibleSidebar activeItem="sessions" activeAgentId={agent.id} sidebarOpen={sidebarOpen} onToggle={toggleSidebar} />
