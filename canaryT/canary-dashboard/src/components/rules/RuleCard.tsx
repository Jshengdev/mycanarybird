  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        {rule.stats.totalEvaluations > 0 ? (
          <ScoreBadge score={rule.stats.passRate} size="sm" />
        ) : (
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '12px', fontWeight: 400, color: 'var(--icon-grey)' }}>—</span>
        )}
      </div>
