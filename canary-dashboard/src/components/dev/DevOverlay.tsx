      ...
      {open && (
        ...
        >
          ...
          <DevSection title="Onboarding">
            ...
            <DevButton label="▶ Start onboarding tour" onClick={() => onboarding?.startOnboarding()} />
            <DevButton label="↺ Reset onboarding state" onClick={() => { localStorage.removeItem('onboarding_completed'); onboarding?.resetOnboarding(); }} />
          </DevSection>
          ...
          <DevSection title="Data State Presets">
            <DevButton label="Active session running" onClick={() => {
              ...
              LIVE_SESSION_STATE.agentId = 'email-agent';
              forceUpdate((n) => n + 1);
            }} />
