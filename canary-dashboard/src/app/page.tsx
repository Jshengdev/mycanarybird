...
export default function Home() {
  ...
  return (
    <div className="flex" style={{ minHeight: '100vh' }}>
      ...
      {sidebarOpen && <Sidebar activeItem="" onCollapse={() => setSidebarOpen(false)} />}
      {!sidebarOpen && <SidebarOpenButton onClick={() => setSidebarOpen(true)} />}

      <div className="flex flex-col" style={{ flex: 1, marginLeft: sidebarOpen ? 'var(--sidebar-width)' : 0, transition: 'margin-left var(--transition-fast)' }}>
        <main
          style={{
            flex: 1,
            background: 'var(--bg)',
          ...
          {loading ? (
            ...
            <div className="flex flex-col" style={{ gap: 'var(--space-10)' }}>
              ...
              {(SESSIONS.length === 0 || freshMode) ? (
                ...
                >
                  <span style={{ fontFamily: 'var(--font-mono)', fontSize: '14px', fontWeight: 700, color: 'var(--accent-color)' }}>
                    ◆ Canary
                  </span>
